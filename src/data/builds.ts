...
export const BUILDS: Build[] = [
  ...
  {
    id: 'layout-tiny-starter',
    name: 'Tiny Starter (7×7)',
    category: 'Layouts',
    difficulty: 'Easy',
    creator: 'MC Circle Generator',
    sourceUrl: 'https://minecraftcircle-generator.com/house-designs/starter',
    image: '/images/layout-tiny-starter.png',
  },
  {
    id: 'layout-cozy-starter',
    name: 'Cozy Starter (9×9)',
    category: 'Layouts',
    difficulty: 'Easy',
    creator: 'MC Circle Generator',
    sourceUrl: 'https://minecraftcircle-generator.com/house-designs/starter',
    image: '/images/layout-cozy-starter.png',
  },
  {
    id: 'layout-l-shape',
    name: 'L-Shape Starter (11×9)',
    category: 'Layouts',
    difficulty: 'Easy',
    creator: 'MC Circle Generator',
    sourceUrl: 'https://minecraftcircle-generator.com/house-designs/starter',
    image: '/images/layout-l-shape.png',
  },
  {
    id: 'layout-timber-cottage',
    name: 'Timber Cottage (9×7)',
    category: 'Layouts',
    difficulty: 'Easy',
    creator: 'MC Circle Generator',
    sourceUrl: 'https://minecraftcircle-generator.com/house-designs/medieval',
    image: '/images/layout-timber-cottage.png',
  },
  {
    id: 'layout-village-tavern',
    name: 'Village Tavern (11×9)',
    category: 'Layouts',
    difficulty: 'Medium',
    creator: 'MC Circle Generator',
    sourceUrl: 'https://minecraftcircle-generator.com/house-designs/medieval',
    image: '/images/layout-village-tavern.png',
  },
  {
    id: 'layout-modern-villa',
    name: 'Modern Villa (15×11)',
    category: 'Layouts',
    difficulty: 'Medium',
    creator: 'MC Circle Generator',
    sourceUrl: 'https://minecraftcircle-generator.com/house-designs/modern',
    image: '/images/layout-modern-villa.png',
  },
]